...
| **김서현** | 팀원 | **QA / Docs** | 문서 관리, 단위/통합 테스트 작성 |
| **신동하** | 팀원 | **AI / Data** | ChromaDB 구축 |
| **이호연** | 팀원 | **BackEnd** | FastAPI 서버 구축, SQLite DB 설계 |
| **최영수** | 팀원 | **AI / Data** | YOLOv11 모델 학습, 음식 이미지 데이터 전처리 . RAG 엔진 개발 , 영양 DB 전처리|
---
